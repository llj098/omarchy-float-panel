...
for required in (
    ...
    '"tasklist.activate"',
    'float-panel-debug',
    "TaskListModel.actionForGroup(group, clients, groupCycleStarts[groupKey])",
...
for required in (
    ...
    'monitor_bounds_cache = {}',
    'update_monitor_bounds_cache(monitor)',
    'debug_window_action("reflow.window"',
